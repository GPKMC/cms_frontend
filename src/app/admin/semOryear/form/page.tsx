...
export default function SemesterOrYearForm() {
    ...
    // Action after modal confirm: "cancel" or "back"
    ...
    useEffect(() => {
        ...
        setLoading(true);
        axios.get(batchUrl, { params: { faculty } })
            .then(res => {
                const bts: Batch[] = Array.isArray(res.data) ? res.data : res.data.batches;
                setBatches(bts || []);
                setBatch("");
            })
            .catch(() => {
    ...
    const handleCancelClick = () => {
        if (isFormDirty()) {
            ...
            // No changes, safe to clear/reset form
            resetForm();
        }
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            disabled={!faculty || batches.length === 0}
                            required
                        >
