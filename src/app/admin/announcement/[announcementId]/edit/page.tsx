...
import TiptapEditor from "../../notification_rte_comenent"; // adjust relative path if needed
...
/** =================== EDIT PAGE =================== */
export default function AnnouncementEditPage({ id: idProp }: { id?: string }) {
  ...
  const id =
    ...
    (typeof params?.announcementId === "string"
      ...
      : Array.isArray(params?.announcementId)
