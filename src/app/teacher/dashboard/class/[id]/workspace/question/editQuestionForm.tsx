...
export default function QuestionEditForm({
  ...
  // --- States ---
  console.log("QuestionEditForm received QuestionId:", QuestionId);
...
useEffect(() => {
  ...
  (async () => {
    ...
    if (!data.question) {
      toast.error(data.error || "question not found.");
      setLoading(false);
      return;
    }
    ...
    setVisibleTo(data.question.visibleTo || []);
    setMutedStudents(data.question.mutedStudents || []);
    if (editor) editor.commands.setContent(data.question.content || "");
    setLoading(false);
  })();
...
console.log("FormData topic (should match above):", formData.get("topic"));
      ...
      toast.success("✅ Questtion updated!");
            ...
            <div className="flex-1 min-w-0 flex flex-col max-h-[68vh] overflow-y-auto">
              ...
              <div className="border-2 rounded-lg bg-gray-50 focus-within:border-blue-300 mb-3">
                <div className="p-3 pb-0">
                  <div className="text-sm text-gray-600 mb-2">Write your question</div>
